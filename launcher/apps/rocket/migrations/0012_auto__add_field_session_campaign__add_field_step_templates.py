...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.campaign'
        db.add_column('rocket_session', 'campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rocket.Campaign'], null=True, blank=True), keep_default=False)

        # Adding field 'Step.templates'
        db.add_column('rocket_step', 'templates', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.campaign'
        db.delete_column('rocket_session', 'campaign_id')

        # Deleting field 'Step.templates'
        db.delete_column('rocket_step', 'templates')
