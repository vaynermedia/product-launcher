...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.meta'
        db.add_column('rocket_customer', 'meta', self.gf('django.db.models.fields.TextField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.meta'
        db.delete_column('rocket_customer', 'meta')
